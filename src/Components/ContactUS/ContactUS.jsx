...
const ContactUS = () => {
    return (
        <>
            ...
            <div>
                <h1 className='text-center text-slate-600 text-5xl font-semibold mt-8'>Contacts</h1>
